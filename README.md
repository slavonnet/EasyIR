...
**Release 0.2.4** — hub-centric architecture (ZHA TS1201) + EasyIR sidebar page with grid wizard. См. [CHANGELOG.md](CHANGELOG.md) и [roadmap](docs/roadmap.yaml).
...
2. Install **EasyIR** `0.2.4`, restart Home Assistant.
